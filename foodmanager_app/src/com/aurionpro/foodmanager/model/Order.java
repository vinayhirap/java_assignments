...
public class Order {
    ...
    private double totalAmount; // subtotal before discount
    ...
    public Map<Food, Integer> getItemsOrdered() { return itemsOrdered; }
    ...
    public double getTotalPayable() { return totalPrice; }
    ...
    public void clearCart() { itemsOrdered.clear(); }
}
