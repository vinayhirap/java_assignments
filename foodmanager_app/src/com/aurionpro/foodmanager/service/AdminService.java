...
public class AdminService {
    ...
    public void adminPanel(Scanner scanner, Menu menu, List<Order> allOrders, List<DeliveryAgent> agents) {
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case "2" -> lastId = addFoodToMenu(menu, scanner, lastId);
    ...
    private int addFoodToMenu(Menu menu, Scanner scanner, int currentId) {
        ...
        while (true) {
            ...
            String cuisineInput = scanner.nextLine().trim().toUpperCase();
            try {
