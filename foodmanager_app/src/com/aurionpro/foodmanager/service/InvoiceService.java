...
public class InvoiceService {
    ...
    public void printInvoice(Order order, DeliveryAgent deliveryAgent) {
        System.out.println("\n=========== INVOICE ===========");
        ...
        for (Map.Entry<Food, Integer> entry : order.getItemsOrdered().entrySet()) {
            ...
            System.out.printf("%-25s %-5d %-10.2f%n", food.getName(), quantity, price);
        }
        ...
        System.out.printf("%-30s %10s%n", "Delivery Agent:", deliveryAgent.getName());
