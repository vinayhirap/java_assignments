...
<title>Withdraw Money - Aurionpro Bank</title>
<link
...
<body>
	...
	<div class="container mt-5">
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="card">
					<div class="card-header withdraw-card">
						<h4>
							<i class="fas fa-minus-circle me-2"></i>Withdraw Money
						</h4>
						<p class="mb-0">Withdraw money from your account</p>
					</div>
					<div class="card-body">
						<%
						...
						<form method="post" action="withdraw">
							<div class="row">
								<div class="col-md-6 mb-3">
									<label for="accountId" class="form-label"> <i
										class="fas fa-university me-2"></i>Withdraw From Account *
							...
							<div class="mb-3">
								...
								<textarea class="form-control" id="description"
									...
									placeholder="Enter withdrawal purpose or remarks"></textarea>
							</div>

							<div class="alert alert-warning">
								<i class="fas fa-exclamation-triangle me-2"></i> Please ensure
								you have sufficient balance before withdrawing.
							</div>
