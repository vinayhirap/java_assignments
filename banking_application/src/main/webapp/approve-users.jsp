...
<title>Approve Users - Aurionpro Bank Admin</title>
<link
...
<body>
	...
	<!-- Sidebar mimic from admin dashboard -->
	<nav class="sidebar">
		<div class="p-4">
			...
			<ul class="nav nav-pills flex-column">
				...
				<li class="nav-item"><a class="nav-link active"
					href="approve-users"> <i class="fas fa-user-check me-2"></i>Approve
						Users
				</a></li>
	...
	<div class="main-content">
		...
		%>
		<div class="alert alert-info">No pending users for approval.</div>
		<%
		} else {
		%>
		<table class="table table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><a
						href="manage-users?action=approve&userId=<%=user.getUserId()%>"
						class="btn btn-success btn-sm"> <i class="fas fa-check"></i>
							Approve
					</a> <a href="manage-users?action=reject&userId=<%=user.getUserId()%>"
